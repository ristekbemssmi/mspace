        ...
        <footer className="relative w-full text-white pt-16 pb-8">
            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-12 items-start px-6 md:px-12">
                    ...
                    {/* Column: Brand & Socials */}
                    <div className="col-span-2 md:col-span-1 order-1 md:order-2 flex flex-col items-center gap-4">
                        <div className="flex items-center gap-4 md:gap-6">
                            <img src="/img/logo.svg" alt="Logo BEM SSMI" width="80" height="80" className="w-12 md:w-20 h-auto" />
                        ...
                        <div className="flex gap-4 mt-2 md:mt-4">
                            <a href="mailto:bemssmi@apps.ipb.ac.id" aria-label="Email BEM SSMI" className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all hover:scale-110">
                                <Mail size={18} />
                            </a>
                            <a href="#" aria-label="LinkedIn BEM SSMI" className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all hover:scale-110">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                            </a>
                            <a href="https://wa.me/628123650305" aria-label="WhatsApp BEM SSMI" className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all hover:scale-110">
                                <MessageCircle size={18} />
                            </a>
                            <a href="https://instagram.com/bemssmiipb" aria-label="Instagram BEM SSMI" className="p-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all hover:scale-110">
